...
<img src="http://latex.codecogs.com/gif.latex?c_k=\frac{1}{N_C}\\sum_{(x_i,y_i)\\inS_K}f_{\\phi}(x_i)"/>计算每个类的原型向量<img src="http://latex.codecogs.com/gif.latex?c_k"/>。并依此对所有query set的样本进行分类，通过得到的损失更新网络。
